/****************************************************************************
Title:    SSD1306 Accelerometer 
Author:   Elegantcircuits.com
File:     $Id: ssd1306_accelerometer
...
AXL335 to Atmega ADC Connections
VCC -> 3.3V
X   -> (Pin 24)
Y   -> (Pin 25)
Z   -> (Pin 26)
...
static uint8_t buffer[(128 * 64) / 8] = { // Default Initialization of 128 x 64 display
...
void setup_i2c(){
    ...
    i2c_write(0x81);                   // Set Contrast Command - 0x81
    i2c_write(0x00);                    // Reset 0x7F
                                        // flips display
